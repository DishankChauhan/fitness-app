    ...
    <ParallaxScrollView
      ...
      <Collapsible title="File-based routing">
        <ThemedText>
          ...
          <ThemedText type="title">app/(tabs)/index.tsx</ThemedText> and{' '}
          <ThemedText type="title">app/(tabs)/explore.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
          The layout file in <ThemedText type="title">app/(tabs)/_layout.tsx</ThemedText>{' '}
